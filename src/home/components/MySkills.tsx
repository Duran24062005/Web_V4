    ...
    <section id="skills" className="py-20 z-20 relative">
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    <div className="bg-gray-900 backdrop-blur-xl p-6 rounded-lg text-center">
                        <i className="fab fa-html5 text-5xl mb-4 text-orange-400"></i>
                    ...
                    <div className="bg-gray-900 backdrop-blur-xl p-6 rounded-lg text-center">
                        <i className="fab fa-github text-5xl mb-4 text-black"></i>
