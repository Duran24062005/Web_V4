...
export const data: Project[] = [
  {
    ...
    content: `La elección entre MongoDB y PostgreSQL es una de las decisiones más importantes en el desarrollo backend.

## MongoDB – Base de Datos NoSQL
MongoDB brilla en aplicaciones que requieren flexibilidad de esquema y escalabilidad horizontal.  
Es ideal para:
...
## Mi Recomendación
Para un portafolio o blog, MongoDB es excelente por su flexibilidad.  
Para e-commerce o finanzas, PostgreSQL es más adecuado por sus garantías ACID.

En proyectos grandes, muchas empresas usan ambas (polyglot persistence).  
